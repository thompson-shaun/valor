...
| Get dressed independently | +1 | Without repeated reminders |
| Eat breakfast on time | +1 | Finishes within a reasonable window |
| Ready for school on time | +1 | Backpack, shoes, out the door |
...
| Homework completed cooperatively | +2 | Done without major resistance or tears |
...
| Positive attitude / kind words | +1 | General cooperation and kindness |
| Bedtime routine on time | +1 | Teeth, PJs, in bed without a battle |
| Reading time | +1 | Even 10–15 min counts |
